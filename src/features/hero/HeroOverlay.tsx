  ...
  return (
    <div className={styles.layout}>
      <div className={`${styles.story} text-start`}>
        ...
        <div
          className={`${styles.displayTitle} mt-5 [font-family:var(--font-display)] text-[clamp(3.7rem,15vw,6rem)] font-semibold leading-[0.86] tracking-[-0.045em] text-[var(--text)] md:text-[clamp(4.6rem,8vw,6.5rem)] lg:text-[clamp(4.25rem,5.7vw,7rem)] xl:text-[clamp(3.8rem,4.8vw,5rem)] cinema:text-[clamp(4.25rem,5.7vw,7rem)]`}
          aria-hidden="true"
          data-hero-animate
        >
        ...
        <p
          ...
          data-hero-animate
        >
          I build digital experiences from the system underneath the interface.
        </p>
